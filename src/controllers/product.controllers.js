...
const createProduct = async (req, res) => {
    ...
    try {
        ...
        // Broadcast to everyone browsing the shop, so it shows up live without a refresh
        try {
            await pusher.trigger("public-products", "new-product", products);
        } catch (pushErr) {
            console.log(pushErr, "pusher trigger failed for new-product");
        }
...
const deleteProduct = async (req, res) => {
    ...
    try {
        ...
        try {
            await pusher.trigger("public-products", "product-deleted", { _id: id });
        } catch (pushErr) {
            console.log(pushErr, "pusher trigger failed for product-deleted");
        }
...
const updateProduct = async (req, res) => {
    try {
        ...
        try {
            await pusher.trigger("public-products", "product-updated", updatedProduct);
        } catch (pushErr) {
            console.log(pushErr, "pusher trigger failed for product-updated");
        }
